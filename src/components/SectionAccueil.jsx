        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl">
              Chez Lumel Optique, nous croyons qu’une bonne paire de lunettes ne
              se choisit pas à la légère. C’est pourquoi nous vous accompagnons
              avec expertise, bienveillance et style, pour vous aider à trouver
              la solution visuelle qui vous correspond.
            </p>
