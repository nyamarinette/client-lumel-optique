            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                ...
                <p className="text-normal text-lg sm:text-xl font-medium text-gray-600 dark:text-gray-400 mt-2">
                  Vous avez une question, besoin d’un conseil ou souhaitez
                  prendre rendez-vous pour un examen de la vue ? Notre équipe
                  d’opticiens est à votre écoute ! <br />
                  <br />
                ...
                <div className="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                  ...
                  <div className="ml-4 text-md tracking-wide font-semibold w-40">
                    +237 676 13 64 81 / +237 655 54 38 65
                  </div>
                </div>
